...
private:
	...
	uint32_t start_tick;
	static const int rewind_time = 83;

	static constexpr const SoundBehavior sound_behavior_parameters[] = {
		{0.5, 5, 1, 1},
		{1, 10, 1, 1},
		{2, 15, 1, 1}
	};

	static constexpr const SoundBehavior sound_obstruct_behavior_parameters[] = {
